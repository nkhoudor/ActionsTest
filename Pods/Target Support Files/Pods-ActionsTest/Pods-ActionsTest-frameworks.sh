...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/iOSBaseViews/iOSBaseViews.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/iOSCoreSDK/iOSCoreSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/iOSKyc/iOSKyc.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/iOSKycSDK/iOSKycSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/iOSKycViews/iOSKycViews.framework"
fi
