//
//  DriverLicenseBackMaskCameraConfigurator.swift
//  iOSKyc
//
...
class DriverLicenseBackMaskCameraConfigurator : MaskCameraConfiguratorProtocol {
    ...
    var topLabelFactory: Factory<UILabel>? {
        return screenProfile.getLabelFactory("DRIVER_LICENSE")
    }
    
    var secondaryLabelFactory: Factory<UILabel>? {
        return screenProfile.getLabelFactory("BACKPAGE")
    }
